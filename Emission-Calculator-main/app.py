...
def render_landing_page():
    ...
    # Current time display for dynamic content
    ...
    st.markdown(f"""
        <div class="hero-section">
            ...
            <button class="cta-button" id="login-btn">Get Started</button>
            
            <div style="position: absolute; bottom: 20px; left: 20px; font-size: 0.9rem; opacity: 0.7;">
